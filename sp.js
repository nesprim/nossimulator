$(document).ready(function(){
    $(function(e){
        function t(){
            e("#wrapperIconeSp div img").mouseenter(function(){
                e(this).animate({
                    height:"40px",
                    width:"40px"
                },300)});
            e("#wrapperIconeSp div img").mouseleave(function(){
                e(this).animate({
                    height:"36px",
                    width:"36px"
                },300)})}
        ...
        function i(){
            ...
            setTimeout(function(){
                ...
                s(varSP, varUP);
                f(varSP, varUP);
                l(varSP, varUP, varCrash, varFail, varGold, varMoon, varWing, varBlue, varRed)},1700)
        }
        function s(t, n){
            var r = parseInt(t);
            var i = arrayNome[r];
        ...
        function f(t, n){
            ...
            if(t == "5" || t == "6" || t == "7" t || t == "8" || t == "13" || t ==" 14" || t == "15" || t == "16" || t == "20" || t == "21" || t == "22" || t == "23" || t == "24"){
                if(r <= 4){
                    ...
                    var d = "Sangue di Drago"
                }
                else if(r >= 10 && r<= 14){
                    var p = "imgSp/heart.jpg";
                    if(n != "10"){
                        var d = "Cuori di Drago"
                    }
                    else{
                        var d = "Cuore di Drago"
                    }
                }
                else{
            ...
            var y = arrayCrash[n];
            var b = arrayFail[n];
            var w = "Successo: " + g + "<br />Distruzione: " + y +"<br />Fallimento: " + b;
        ...
        function l(t, n, r, i, s, o, u, a, f){
            ...
            var w = e.number(a, 0);
            var E = e.number(f, 0);
            var S = "Hai iniziato con un:<br /><p>" + h +" +" + varOldUP + "</p>Ora hai un:<br /><p>" + h + " +" + n + "</p><br />Fallimenti totali: " + d + "<br />Distruzioni: " + v + "<br />Fallimenti: " + m + "<br />Soldi usati: " + g + "<br />Lune Piene usate: " + y + "<br />Ali d'Angelo usate: " + b + "<br />Rotoli blu usati: " + w + "<br />Rotolo rossi usati: " + E;
            e("#wrapperDestro #statistiche p").html(S)
        }
        function h(){
        ...
        function p(t, n, r){
            ...
            if(r == 0){
                ...
                var s = "Congratulazioni!! Hai ottenuto un " + i +" +" + n
            }
            else{
                e("#banner").css({display:"block", backgroundColor:"rgba(0, 0, 0, 0.9)"});
                if(r == 1){
                    var s = "Tentativo fallito!!"
                }
                else{
                var s = "La Carta è stata distrutta!!"}
            }
            e("#banner p").text(s);
            setTimeout(function(){
                e("#banner").css("display", "none")
            },1700)
        }
        function d(t){
            var n = parseInt(t);
